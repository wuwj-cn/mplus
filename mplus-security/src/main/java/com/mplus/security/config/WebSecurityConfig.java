package com.mplus.security.config;

import java.util.Arrays;
import java.util.List;

import com.mplus.security.filter.MyFilterSecurityInterceptor;
import com.mplus.security.filter.MyUsernamePasswordAuthenticationFilter;
import com.mplus.security.handler.MyAccessDeniedHandler;
import com.mplus.security.handler.MyAuthenticationFailureHandler;
import com.mplus.security.handler.MyAuthenticationSuccessHandler;
import com.mplus.security.handler.MyLogoutSuccessHandler;
import com.mplus.security.service.MyUserDetailService;
...
import com.mplus.security.jwt.JwtAuthenticationEntryPoint;
import com.mplus.security.jwt.JwtAuthenticationTokenFilter;
import com.mplus.security.utils.SkipPathRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Value("${jwt.route.auth.login}")
    private String loginUrl;
    
    @Value("${jwt.route.auth.logout}")
    private String logoutUrl;

    // 不需要认证的接口
    @Value("${com.mplus.security.antMatchers}")
...
//                .loginProcessingUrl("/auth/v1/api/login/entry")  // 此登录url 和Controller 无关系
                .loginProcessingUrl(this.loginUrl)
...
//                .logoutUrl("/auth/v1/api/login/logout")
    ...
    public JwtAuthenticationTokenFilter authenticationTokenFilterBean() throws Exception {
        ...
        List<String> pathsToSkip = Arrays.asList(
        		"/auth/v1/api/login/retrieve/pwd",
        		"/auth/v1/api/login",
        		"/auth/v1/api/login/enter");  //不需要token 验证的url
